...
function playAll(songNumber){
    ...
    if(audioElement.getAttribute("src")==songFileName && !audioElement.paused){
        ...
        if (songNumber === 1) {
            ...
            bannerHeading.textContent = "Butta Bomma(Ala Vaikunthapurramuloo)";
            bannerText.textContent = "By Arman malik";
            ...
            bannerHeading.textContent = "Samajavaragamana(Ala Vaikunthapurramuloo)";
            ...
            bannerHeading.textContent = "Ramuloo Ramulaa (Ala Vaikunthapurramuloo)";
            bannerText.textContent = "By Anurag Kulkarni";
        }
